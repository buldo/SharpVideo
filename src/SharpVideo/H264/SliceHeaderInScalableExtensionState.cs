...
public class SliceHeaderInScalableExtensionState
{
    // input parameters
    ...
    public uint32_t base_pred_weight_table_flag = 0;
    ...
    public uint32_t ref_layer_dq_id = 0;
    public uint32_t disable_inter_layer_deblocking_filter_idc = 0;
    public int32_t inter_layer_slice_alpha_c0_offset_div2 = 0;
    public int32_t inter_layer_slice_beta_offset_div2 = 0;
    public uint32_t constrained_intra_resampling_flag = 0;
    public uint32_t ref_layer_chroma_phase_x_plus1_flag = 0;
    public uint32_t ref_layer_chroma_phase_y_plus1 = 0;
    public int32_t scaled_ref_layer_left_offset = 0;
    public int32_t scaled_ref_layer_top_offset = 0;
    public int32_t scaled_ref_layer_right_offset = 0;
    public int32_t scaled_ref_layer_bottom_offset = 0;
    public uint32_t slice_skip_flag = 0;
    public uint32_t num_mbs_in_slice_minus1 = 0;
    public uint32_t adaptive_base_mode_flag = 0;
    public uint32_t default_base_mode_flag = 0;
    public uint32_t adaptive_motion_prediction_flag = 0;
    public uint32_t default_motion_prediction_flag = 0;
    public uint32_t adaptive_residual_prediction_flag = 0;
    public uint32_t default_residual_prediction_flag = 0;
    public uint32_t tcoeff_level_prediction_flag = 0;
    public uint32_t scan_idx_start = 0;
    public uint32_t scan_idx_end = 0;
    ...
    public static uint32_t getSliceGroupChangeCycleLen(
